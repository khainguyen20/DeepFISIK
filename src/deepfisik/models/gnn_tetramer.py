...
class GNNTetramer(torch.nn.Module):
    def __init__(self, model_params):
        super(GNNTetramer, self).__init__()
        ...
        self.AP4Out = Linear(int(node_embedding_size/4), 1)
        self.DR4Out = Linear(int(node_embedding_size/4), 1)
    ...
    def forward(self, x, edge_index,edge_attr, batch_index, device):
        ...
        return x, edge_attr, u,DC,AP2,AP3,AP4, DR2,DR3,DR4,RD,LF #gelu1, gelu2#, attention_coeffs
